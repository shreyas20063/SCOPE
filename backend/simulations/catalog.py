...
SIMULATION_CATALOG = [
    ...
    # =========================================================================
    {
        ...
        "description": "Design and tune PID and Lead-Lag controllers for various plants. Compare tuning methods including Ziegler-Nichols, Cohen-Coon, Lambda, IMC, and ITAE optimal.",
        "category": "Control Systems",
        "thumbnail": "🎛️",
        "tags": ["PID", "tuning", "Ziegler-Nichols", "control", "step response", "Bode", "stability"],
        "has_simulator": True,
        "controls": [
