    ...
    },
    {
        ...
        "controls": [
            ...
            {"type": "expression", "name": "custom_num", "label": "Numerator Coefficients",
             "default": "1", "placeholder": "e.g. 1  or  1, 2", "group": "Plant",
             "visible_when": {"plant_preset": "custom"}},
            {"type": "expression", "name": "custom_den", "label": "Denominator Coefficients",
             "default": "1, 1", "placeholder": "e.g. 1, 3, 2 for s²+3s+2", "group": "Plant",
             "visible_when": {"plant_preset": "custom"}},
            # Controller group
            ...
            {"type": "slider", "name": "pp_pole3_imag", "label": "Pole 3 Imag",
             "min": -20, "max": 20, "step": 0.1, "default": 0.0, "group": "Controller",
             "visible_when": {"controller_type": "pole_placement"}},
            {"type": "slider", "name": "pp_pole4_real", "label": "Pole 4 Real",
             "min": -20, "max": 0, "step": 0.1, "default": -7.0, "group": "Controller",
             "visible_when": {"controller_type": "pole_placement"}},
            {"type": "slider", "name": "pp_pole4_imag", "label": "Pole 4 Imag",
             "min": -20, "max": 20, "step": 0.1, "default": 0.0, "group": "Controller",
             "visible_when": {"controller_type": "pole_placement"}},
            {"type": "button", "name": "apply_pole_placement", "label": "Compute K",
             "group": "Controller", "visible_when": {"controller_type": "pole_placement"}},
            # LQR
            {"type": "slider", "name": "lqr_q1", "label": "Q\u2081\u2081 (state 1 weight)",
             "min": 0.01, "max": 100, "step": 0.1, "default": 1.0, "group": "Controller",
             "visible_when": {"controller_type": "lqr"}},
            {"type": "slider", "name": "lqr_q2", "label": "Q\u2082\u2082 (state 2 weight)",
             "min": 0.01, "max": 100, "step": 0.1, "default": 1.0, "group": "Controller",
             "visible_when": {"controller_type": "lqr"}},
            {"type": "slider", "name": "lqr_q3", "label": "Q\u2083\u2083 (state 3 weight)",
             "min": 0.01, "max": 100, "step": 0.1, "default": 1.0, "group": "Controller",
             "visible_when": {"controller_type": "lqr"}},
            {"type": "slider", "name": "lqr_q4", "label": "Q\u2084\u2084 (state 4 weight)",
             "min": 0.01, "max": 100, "step": 0.1, "default": 1.0, "group": "Controller",
             "visible_when": {"controller_type": "lqr"}},
            {"type": "slider", "name": "lqr_r", "label": "R (control weight)",
             "min": 0.001, "max": 100, "step": 0.01, "default": 1.0, "group": "Controller",
             "visible_when": {"controller_type": "lqr"}},
            {"type": "button", "name": "apply_lqr", "label": "Compute LQR K",
             "group": "Controller", "visible_when": {"controller_type": "lqr"}},
            # Tuning group
            ...
            {"type": "button", "name": "es_train", "label": "Train ES Policy", "group": "Tuning",
             "visible_when": {"tuning_method": "es_adaptive"}},
            {"type": "slider", "name": "rl_timesteps", "label": "PPO Timesteps",
             "min": 10000, "max": 500000, "step": 10000, "default": 100000, "group": "Tuning",
             "visible_when": {"tuning_method": "ppo_rl"}},
            {"type": "button", "name": "ppo_train", "label": "Train PPO Agent", "group": "Tuning",
             "visible_when": {"tuning_method": "ppo_rl"}},
            # Display group
